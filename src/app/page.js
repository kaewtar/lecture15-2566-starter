...
const schema = z.object({
  firstName: z.string().min(3, { message: "Requred at least 3 characters" }),
  lastName: z.string().min(3, { message: "Requred at least 3 characters" }),
  email: z.string().min(3, { message: "Invalid email format" }),
